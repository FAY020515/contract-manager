...
const dbApi = {
  ...
  addLog(contractId, action, detail, operator) {
  ...
  createAttachment(contractId, filename, originalName, mimeType, size, uploader) {
    runSql(`
  ...
  deleteAttachmentsByContract(contractId) {
  ...
  getAttachmentCountByContract(contractId) {
