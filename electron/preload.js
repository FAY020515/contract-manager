...
const api = {
  ...
  createContract: (contract, operator) => ipcRenderer.invoke('contracts:create', contract, operator),
  updateContract: (id, contract, operator) => ipcRenderer.invoke('contracts:update', id, contract, operator),
